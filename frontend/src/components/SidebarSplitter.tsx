...
/**
 * Vertical drag handle. Sits between the floor canvas (left) and the
 * sidebar (right). Drag left -> wider sidebar. Cursor + pixel-stripe
 * affordance.
 */
export function SidebarSplitter({ width, onChange, viewportWidth, min = 320, max = 1200 }: SidebarSplitterProps) {
  ...
  return (
    <div
      ...
      style={{
        ...
        flexShrink: 0,
        position: 'relative',
        background: active ? 'var(--corp-cream-300)' : 'transparent',
      }}
    >
      ...
      <div
        style={{
          ...
          left: 4,
          width: 2,
          background: active ? 'var(--corp-ink-900)' : 'var(--corp-ink-300)',
        }}
      />
      <div
        style={{
      ...
      >
        <span style={{ height: 2, background: 'var(--corp-ink-900)' }} />
        <span style={{ height: 2, background: 'var(--corp-ink-900)' }} />
        <span style={{ height: 2, background: 'var(--corp-ink-900)' }} />
      </div>
    </div>
