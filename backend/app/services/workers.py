...
async def _run_worker(org_id: str, worker_id: str, conversation: str, prompt: str) -> None:
    ...
    try:
        ...
        # tear down" identity.
        reply = await run_agent_turn(_worker_agent, _session_service, org_id, worker_id, prompt)
...
def spawn_worker(org_id: str, source_event: str, prompt: str) -> str:
    ...
    task = asyncio.create_task(_run_worker(org_id, worker_id, conversation, prompt))
